...
const Faqs = () => {
  ...
  const questions = [
    ...
    },
    {
      ...
      answer:
        "Capture and Go doesn't allow you to book multiple appointments at once. It'll only allow you to book them one at a time.",
    },
    {
    ...
    {
      question: 'Does Capture and Go accept cancellations?',
      answer:
  ...
  return (
    <>
      ...
      <div className='text-lg px-2 w-full font-inter'>
        <div className='px-2 py-4 border border-t-black text-center'>
          ALL RIGHTS RESERVED | CAPTURE AND GO {new Date().getFullYear()}
        </div>
      </div>
    </>
  )
